...
import de.fh_zwickau.taskerapp.todoapp.db.TaskAdapter;
import de.fh_zwickau.taskerapp.todoapp.db.TaskContract;

import static de.fh_zwickau.taskerapp.todoapp.db.TaskContract.DATE_SORT;
import static de.fh_zwickau.taskerapp.todoapp.db.TaskContract.DEFAULT_SORT;

public class TodoEntryActivity extends AppCompatActivity implements TaskAdapter.OnItemClickListener,
    ...
    public void onResume() {
        super.onResume();
        getLoaderManager().restartLoader(TASK_LOADER, null, TodoEntryActivity.this);
    }
    ...
    public void onItemClick(View v, int position) {
        Intent intent = new Intent(TodoEntryActivity.this, TaskDetailActivity.class);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        } else if (orderBy.equals(this.getString(R.string.pref_sortBy_deadline))) {
        ...
        return new CursorLoader(this, TaskContract.CONTENT_URI, projection, null, null, orderByConstant);
    }
